...
def calculate_value_similarity(query_table, candidate_table, sample_size=100):
    # Extract values from string (object) columns
    query_values = set()
...
def compare_value_similarity_all_csvs(query_path, folder_path, sample_size=100):
...
# === USAGE EXAMPLE ===
query_file = "base/1.csv"  # reference file
folder = "benchmark"                             # folder to scan

similarities_df = compare_value_similarity_all_csvs(query_file, folder, sample_size=100)
